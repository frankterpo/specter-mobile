...
async function run() {
  const companyId = "67fd986d1347c417d52bb229"; // Specter
  
  await fetchSample('CompanyTeam', `/private/companies/${companyId}/people`, { category: 'railway' });
  await fetchSample('DepartmentSizes', `/private/companies/${companyId}/department-sizes`, { category: 'railway' });
