...
async function run() {
  ...
  await fetchSample('SearchHistory', '/private/quick-search/history', { category: 'railway' });
  await fetchSample('SearchCompanies', `/private/quick-search/company?term=${term}`, { category: 'railway' });
  await fetchSample('SearchPeople', `/private/quick-search/people?term=${term}`, { category: 'railway' });
  await fetchSample('SearchCounts', `/private/quick-search/counts?term=${term}`, { category: 'railway' });
